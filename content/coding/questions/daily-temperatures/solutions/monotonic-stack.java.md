...
class Solution {
    public int[] dailyTemperatures(int[] temperatures) {
        ...
        Deque<Integer> stack = new ArrayDeque<>(); // indices awaiting a warmer day
        for (int i = 0; i < n; i++) {
