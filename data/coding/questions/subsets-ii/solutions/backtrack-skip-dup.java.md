...
class Solution {
    public List<List<Integer>> subsetsWithDup(int[] nums) {
        ...
        backtrack(sorted, 0, new ArrayDeque<>(), result);
        return result;
    }
