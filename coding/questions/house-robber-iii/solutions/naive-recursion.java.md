The same direct reading in Java: at every node, either rob it and add whatever the grandchildren yield, or skip it and take the best each child can offer on its own. Recurse on both branches and keep the larger.
